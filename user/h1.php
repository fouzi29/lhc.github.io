    ...
    <div id="bd0">
            ...
            <span class="navbar-toggler-icon "></span>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavDropdown">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item"><a class="nav-link" href="../u1/forum.php">Community</a></li>
                            <li class="nav-item"><a class="nav-link" href="#">Career</a></li>
                            <li class="nav-item"><a class="nav-link" href="lawyerprofile.php">Profile</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-8 col-md-9 col-sm-12" style="background-color:#348f50;border-right:2px solid black;color:white">
                <div class="headers">FAQ </div>

                <p style="padding-top:10px;">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Hic beatae eius quidem ex autem fugit quod eaque illum, ab odio et, numquam veritatis ipsa ratione animi! Perspiciatis quasi laudantium vero! Lorem ipsum dolor sit amet, consectetur
                    adipisicing elit. Qui tempora recusandae modi quibusdam praesentium architecto perspiciatis, sapiente, ullam placeat commodi alias temporibus necessitatibus esse dolore distinctio fugiat dignissimos eos? Quo! Lorem ipsum dolor sit
                    amet, consectetur adipisicing elit. Repudiandae quisquam unde repellendus. Dicta aliquam suscipit nesciunt voluptatibus odit, nihil repellat repellendus, iure ex aspernatur ipsa expedita, officiis, magni accusantium quod.
                </p>
            </div>
