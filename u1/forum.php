...
<body>
 ...
 <div class="input-group input-group-sm mb-3 w-50">
  <div class="input-group-prepend">
    ...
    <a href="#addnew" data-toggle="modal" class="btn btn-primary btn-sm" style="margin-right: 400px;">
 <span class="glyphicon glyphicon-plus"></span>Post Your Problem
   </a></span>
  <input type="text" class="form-control" name="search_text" id="search_text" placeholder="Search by expert Field " aria-label="Small" aria-describedby="inputGroup-sizing-sm">
</div>
			<br />
			<div id="result"></div>
		</div>
